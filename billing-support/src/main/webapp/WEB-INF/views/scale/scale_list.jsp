...
<body>
	<form id="queryForm" name="queryForm" action="${ctx}/scale/list" method="post">
		<div class="page-container">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> 
				<span class="l" style="float: right !important;margin-right: 10px;">
					<a href="javascript:void(0);" onclick="addOrUpdate()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加分成</a>
				</span> 
			</div>
	...
	<script type="text/javascript">
		...
		function addOrUpdate(id){
			var url = "${ctx}/scale/detail";
			if(id != null){
				url += "?id=" + id
			}
			layer_show("添加分成记录", url, '400', '300');
		}
		
		
		function deleteCert(id){
			layer.confirm("此操作将删除该分成记录，您确定要继续吗？", function(index){
				 $.ajax({
                 	url: "${ctx}/scale/delete",
                 	data: {
                 		id: id,
                 	},
